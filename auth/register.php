                        ...
                        <div class="row-lg">
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="doRegister.php">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" placeholder="Username" name="username" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" placeholder="Full Name" name="name" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= $baseUrl . "/auth/register.php"  ?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
