...
$query = "SELECT * FROM asset WHERE admin_id = $id ";
...
{ ?>
    <tr>
      ...
      <td><?=  $row["harga_asset"]?></td>
      <td><?=  $row["tanggal_dibeli"]?></td>
      <td><a class="btn btn-warning" href="<?= $baseUrl . '/dashboard/asset/edit.php?id=' .$row['id'] ?>" >edit</a></td>
      <td><a class="btn btn-danger" href="<?= $baseUrl . '/dashboard/asset/doDelete.php?id=' .$row['id'] ?>"  >delete</a></td>
