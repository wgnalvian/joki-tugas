...
{ ?>
    <tr>
      ...
      <td><?=  $row["kaprodi"]?></td>
      <td><?=  $row["fakultas"]?></td>
      <td><a class="btn btn-warning" href="<?= $baseUrl . '/dashboard/prodi/edit.php?id=' .$row['id'] ?>" >edit</a></td>
      <td><a class="btn btn-danger" href="<?= $baseUrl . '/dashboard/prodi/doDelete.php?id=' .$row['id'] ?>"  >delete</a></td>
