...
$query = "SELECT * FROM pengeluaran WHERE admin_id = $id ";
...
{ ?>
    <tr>
      ...
      <td><?=  $row["tanggal"]?></td>
      <td><a class="btn btn-warning" href="<?= $baseUrl . '/dashboard/pengeluaran/edit.php?id=' .$row['id'] ?>" >edit</a></td>
      <td><a class="btn btn-danger" href="<?= $baseUrl . '/dashboard/pengeluaran/doDelete.php?id=' .$row['id'] ?>"  >delete</a></td>
