<?php
 ...
 $result = mysqli_query($connect,"SELECT * FROM ruang WHERE id = $id");
...
<form method="POST" action="doEdit.php">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $mhs['ruang'] ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="nama" name="nama">
