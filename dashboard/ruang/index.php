...
{ ?>
    <tr>
      ...
      <td><a class="btn btn-warning" href="<?= $baseUrl . '/dashboard/ruang/edit.php?id=' .$row['id'] ?>" >edit</a></td>
      <td><a class="btn btn-danger" href="<?= $baseUrl . '/dashboard/ruang/doDelete.php?id=' .$row['id'] ?>"  >delete</a></td>
